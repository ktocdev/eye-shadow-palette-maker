...
// Debug props
watch(() => props.paletteColors, (colors) => {
  console.log('EyePreviewModal received paletteColors:', colors)
  if (colors && colors.length > 0) {
    console.log('First color example:', colors[0])
  }
...
onMounted(() => {
  console.log('EyePreviewModal mounted')
  if (props.modelValue && canvasElement.value) {
    initializeCanvas(canvasElement.value)
  }
})
</script>
      ...
      <div class="eye-controls">
        ...
        <div class="color-selection-section">
          ...
          <div v-else class="no-colors-message">
            <p>Create a palette first to use colors in the eye preview.</p>
          </div>
        </div>
...
.eye-preview-footer {
  ...
  justify-content: center;
  padding-top: 16px;
  border-top: 1px solid rgba(139, 129, 165, 0.1);
}
