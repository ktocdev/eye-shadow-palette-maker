...
import SavePaletteModal from './palette/SavePaletteModal.vue'
import PaletteManagerModal from './palette/PaletteManagerModal.vue'
import AboutModal from './general/AboutModal.vue'
